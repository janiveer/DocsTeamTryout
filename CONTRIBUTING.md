...
- Bold text: use bold tags for a filename, directory name or something the reader has to notice/click.
- Inline code: use the inline code syntax when you include a variable name, function, class or method name.
